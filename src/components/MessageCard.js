...
const messages = [
    ...
    "Em không chỉ là người quan trong nhất của anh mà còn là bạn thân nhất của anh, là người bạn tâm giao và là tất cả của anh.",
    "Anh trân trọng từng khoảnh khắc chúng ta bên nhau, và anh mong muốn tạo ra nhiều kỷ niệm đẹp hơn nữa.",
    "Chúc mừng Ngày Phụ nữ, người tuyệt vời của anh! Em xứng đáng có được tất cả hạnh phúc trên thế giới này."
];
